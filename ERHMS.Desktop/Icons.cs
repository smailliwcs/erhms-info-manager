...
namespace ERHMS.Desktop
{
    public static class Icons
    {
        ...
        private static readonly IDictionary<string, string> keysByName = new Dictionary<string, string>
        {
            ...
            { "CoreView.WorkerActivityReport", "hard-hat" },
            { "CoreView.WorkerDeploymentRecord", "globe-americas" },
            { "CoreView.WorkerInProcessingForm", "sign-in-alt" },
            { "CoreView.WorkerOutProcessingForm", "sign-out-alt" },
            { "CoreView.WorkerRosteringForm", "id-badge" },
            { "Create", "file" },
            { "Delete", "trash" },
            { "Design", "tools" },
            { "Edit", "pen" },
        ...
        {
            return keysByName.TryGetValue(name, out string key) ? instancesByKey[key] : null;
        }
    }
}
